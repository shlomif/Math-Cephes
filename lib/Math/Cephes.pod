...
=item * Make the configuration of mconf.h automatic.

=item * Include the rest of the routines in the cephes library, such as
 polynomial and matrix manipulation functions; this will involve
 writing typemaps for arrays.
